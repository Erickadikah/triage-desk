          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              ...
              <button
                ...
                aria-label="Dismiss ticket summary"
              >
                <X className="h-4 w-4" />
              </button>
            </div>
      ...
      {toast && (
        <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-bottom-4 fade-in duration-300">
          <div className="flex items-center gap-3 rounded-lg border border-green-200 bg-green-50 px-4 py-3 shadow-lg">
            ...
            <button onClick={() => setToast(false)} className="ml-2 text-green-600 hover:text-green-800 cursor-pointer" aria-label="Dismiss notification">
              <X className="h-4 w-4" />
            </button>
          </div>
        </div>
